                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5 ">
                    <div class="card text-center" style="border-radius: 1rem;">
                        ...
                        <div class="card-header card-header-info bg-info mx-3 text-center">
                            ...
                            <p class="text-white mb-5 text-center"><b>login prueba juan</b></p>
                        </div>
                                ...
                                <form action="{{ route('login')}}" method="post">
                                   @csrf
                                    ...
                                    <div class="form-check d-flex justify-content-start mb-5 ">
                                        <input class="form-check-input mr-1" type="checkbox" id="politicas"  required>
                                        <label class="form-check-label px-3" for="politicas">Politicas</label>
                                    </div>
                                    <div class="mb-3">
                                        <button class="btn btn-outline-info px-4" type="submit">Ingresar</button>
                                    </div>
                                    <div class="mb-4">
